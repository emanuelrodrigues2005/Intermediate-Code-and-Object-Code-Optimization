...
static long long entrada[N] = {S, AP, K, AP, S, I, I, FP, FP, AP, S, AP, S, AP, K, S, FP, K, FP, AP, K, AP, S, I, I, FP, FP, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, S, AP, K, S, FP, AP, K, I, FP, FP, AP, S, AP, K, K, FP, AP, K, 2, FP, FP, FP, FP, AP, S, AP, K, K, FP, AP, K, LT, FP, FP, FP, FP, AP, S, AP, K, K, FP, AP, K, 1, FP, FP, FP, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, S, AP, K, S, FP, AP, K, I, FP, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, K, K, FP, I, FP, FP, AP, S, AP, S, AP, K, S, FP, AP, S, AP, S, AP, K, S, FP, AP, K, I, FP, FP, AP, S, AP, K, K, FP, AP, K, 1, FP, FP, FP, FP, AP, S, AP, K, K, FP, AP, K, SUB, FP, FP, FP, FP, FP, FP, AP, S, AP, K, K, FP, AP, K, MUL, FP, FP, FP, FP, 20, fim_string};
...
void reduzB(long long *array1, long long *array2) {
    int inicio_f, fim_f;
    int inicio_g, fim_g;
    int inicio_x, fim_x;
...
void reduzC(long long *array1, long long *array2) {
    int inicio_f, fim_f;
    int inicio_g, fim_g;
    int inicio_x, fim_x;
...
void reduzD(long long* array1, long long* array2) {
    int inicio_c, fim_c;
    int inicio_f, fim_f;
    int inicio_g, fim_g;
    int inicio_x, fim_x;
...
// do array1 para o array2.
void reduzE(long long* array1, long long* array2) {
    int inicio_c, fim_c;
    int inicio_f, fim_f;
    int inicio_g, fim_g;
    int inicio_x, fim_x;
...
// do array1 para o array2.
void reduzF(long long* array1, long long* array2){
    int inicio_c, fim_c;
    int inicio_f, fim_f;
    int inicio_g, fim_g;
    int inicio_x, fim_x;
...
void reduzY(long long* array1, long long* array2) {
    int inicio_x, fim_x;
